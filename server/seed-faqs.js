...
const faqs = [
    ...
    { category: 'General Questions', sort_order: 2, question: 'How do I apply for an opportunity?', answer: '<p>Each opportunity listing includes contact information for the posting prime contractor. You\'ll need to contact them directly using the information provided and follow their specific application process.</p>' },
    { category: 'General Questions', sort_order: 3, question: 'Can I select multiple work categories?', answer: '<p>Yes, you can select all work categories that apply to your business capabilities. This helps prime contractors find you when searching for small businesses in those categories.</p>' },

    // For Small Businesses
    { category: 'For Small Businesses', sort_order: 0, question: 'How often are new opportunities posted?', answer: '<p>Opportunities are posted regularly as prime contractors have new projects. We recommend checking the platform frequently or enabling email notifications for new opportunities in your selected categories.</p>' },
    ...
    { category: 'For Prime Contractors', sort_order: 0, question: 'Who can post opportunities?', answer: '<p>Caltrans districts, other government agencies, and prime contractors working on Caltrans projects can post opportunities on the platform.</p>' },
