    ...
    try {
        ...
        await db.execute(`
            CREATE TABLE IF NOT EXISTS messages (
                ...
                message_type ENUM('invite', 'application', 'reply', 'system') DEFAULT 'reply',
                subject VARCHAR(255),
                body TEXT NOT NULL,
        ...
        const migrations = [
            ...
            `ALTER TABLE messages ADD COLUMN IF NOT EXISTS message_type ENUM('invite', 'application', 'reply', 'system') DEFAULT 'reply'`,
            `ALTER TABLE messages MODIFY COLUMN message_type ENUM('invite', 'application', 'reply', 'system') DEFAULT 'reply'`,
